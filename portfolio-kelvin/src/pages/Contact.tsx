      ...
      <main className="flex not-sm:flex-col justify-around items-center w-full sm:h-full lgscreen:justify-evenly sm:gap-0 gap-10 not-sm:mt-5">
        <div className="flex flex-col gap-2.5 lgscreen:gap-5 justify-center w-3/4 sm:w-35/100 xl:w-3/10 lgscreen:w-1/4 custom:w-2/3 not-lg:gap-0.5">
          ...
          <div className="flex items-center font-jost text-base sm:text-lg lg:text-xl lgscreen:text-3xl font-light gap-1.5 lgscreen:gap-2.5 sm:pl-1.25">
            ...
            <p>kelvinluizandrade@gmail.com</p>
          </div>
        ...
        <form
          ref={form}
          onSubmit={sendEmail}
          className=" flex flex-col gap-1 bg-zinc-800 text-zinc-200 w-3/4 custom:w-2/3 sm:w-1/2 md:w-45/100 lg:w-2/5 px-3 custom:px-6 lgscreen:px-8 py-3 lgscreen:py-6 lgscreen:gap-5 rounded-lg font-jost"
        >
          <h1 className="text-center text-xl 2xl:text-3xl text:text-4xl font-medium">
            Enviar Mensagem
          </h1>
          <div className="mt-3 custom:mt-4">
            <label
              htmlFor="txt-input"
              className="text-sm 2xl:text-lg lgscreen:text-2xl"
            >
              Nome Completo
            </label>
            <input
              ...
              id="txt-input"
              name="user_name"
              className="w-full h-8 lg:h-10  text-zinc-300  bg-zinc-700 outline-none rounded-md p-3 lg:p-4 text-sm lg:text-base lgscreen:h-14 lgscreen:text-xl mt-2 lgscreen:mt-4"
              placeholder="Digite seu Nome"
              required
            />
          </div>

          <div className="mt-2 custom:mt-4">
            <label
              htmlFor="email-input"
              className="text-sm 2xl:text-lg lgscreen:text-2xl"
            >
            ...
            <input
              ...
              name="user_email"
              id="email-input"
              className="w-full h-8 lg:h-10 bg-zinc-700 outline-none rounded-md p-3 lg:p-4 text-sm lg:text-base text-zinc-300 mt-2 lgscreen:mt-4 lgscreen:h-14 lgscreen:text-xl"
          ...
          <div className="mt-2 custom:mt-4">
            <label
              htmlFor="text-area"
              className="text-sm 2xl:text-xl lgscreen:text-2xl"
            >
              Mensagem
            </label>
            <textarea
              ...
              required
              className="w-full bg-zinc-700 outline-none rounded-md p-3 text-sm lg:text-base text-zinc-300 mt-2 lgscreen:mt-4 h-24 lg:h-36 resize-none lgscreen:h-32 lgscreen:text-xl"
            ></textarea>

            <button
              type="submit"
              className="w-full h-10 2xl:h-14 lgscreen:h-18 bg-zinc-700 border-none rounded-md shadow-sm cursor-pointer text-sm custom:text-base 2xl:text-xl lgscreen:text-2xl text-white font-semibold mt-5 lgscreen:mt-15 hover:bg-zinc-100 hover:text-black transition-colors duration-400"
            >
              Enviar Mensagem
            </button>
          </div>
